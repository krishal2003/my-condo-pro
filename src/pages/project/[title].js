...
const PropertyDetailPage = () => {
  ...
  return (
    <>
    <Head>
      <title>{title} | MyCondosPro</title>
    </Head>
      <Stack alignItems='center' gap={0} flexDirection="row" sx={{ pt: 9, pb: 4,pl:3 }}>
        ...
        <Link href={`{/project/${title}}`} style={{ textDecoration: "none" }}>
            ...
            <Grid item xs={12} md={8}>
              ...
              >
                ...
                >
                  ...
                  <Typography variant="body1">4 bath</Typography>
                  <Typography variant="body1">12021 sq m</Typography>
                </Stack>
